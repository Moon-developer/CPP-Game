...
void Game::start()
{
	...
	_gameState = eGameState::ShowingSplash;
...
void Game::playGame()
{
	...
	Shaders shader("../graphics/Resources/VertexShaders/ShadedModelsVert.glsl",
			"../graphics/Resources/FragmentShaders/ShadedModelsFrag.glsl");
...
Settings Game::_settings{eScreen::s1024, false, true, eVolume::v40, true};
